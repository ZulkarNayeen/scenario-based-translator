...
with col1:
    ...
    st.markdown("""
    # RAG powered by <img src="data:image/png;base64,{}" width="190" class="rounded-image" style="vertical-align: -10px;">
""".format(base64.b64encode(open("assets/gemma.png", "rb").read()).decode()), unsafe_allow_html=True)
